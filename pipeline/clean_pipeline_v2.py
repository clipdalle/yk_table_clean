...
from pipeline.prompts_v2 import PROMPT_BATCH
...
def parse_batch(batch_df: pd.DataFrame) -> List[Dict]:
    ...
    prompt = PROMPT_BATCH.format(
        ...
        known_names=json.dumps(known_names, ensure_ascii=False, indent=2)
    )
...
#    paths = [r'F:\vscode_workspace\smart_table\daily_data\主持打卡9.30.xlsx']
    for p in paths:
        ...
        output_path = p.with_suffix(f'.{CURRENT_MODEL}.output.filter_date_{STRICT_DATE_FILTER}.names_hint.bs_{BATCH_SIZE}.xlsx')
